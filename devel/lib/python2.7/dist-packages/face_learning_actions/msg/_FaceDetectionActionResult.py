...
"""autogenerated by genpy from face_learning_actions/FaceDetectionActionResult.msg. Do not edit."""
import sys
...
class FaceDetectionActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "face_learning_actions/FaceDetectionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','face_learning_actions/FaceDetectionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FaceDetectionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = face_learning_actions.msg.FaceDetectionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = face_learning_actions.msg.FaceDetectionResult()
